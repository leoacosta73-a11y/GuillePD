...
(function(){
  ...
  const dictionaries={
    es:{
      ...
      'fluid.settings.eyebrow':'Módulo opcional',
      'fluid.settings.title':'Registro de líquidos y orina',
      'fluid.settings.subtitle':'Habilitalo solamente si necesitás llevar el balance hídrico diario.',
      'fluid.settings.enable':'Mostrar registro hídrico',
      'fluid.settings.enableHelp':'Agrega en Inicio el ingreso de líquidos, la orina y los dos balances.',
      'fluid.settings.keepData':'Si lo desactivás, los registros existentes se conservan y vuelven a aparecer cuando lo habilites.',
      ...
      'fluid.balance.completedOnly':'Los datos de diálisis incluyen únicamente intercambios terminados.',
      ...
      'fluid.report.of':'de',
      'fluid.report.idHistory':'DNI / HC',
      'fluid.report.responsible':'Responsable',
      'fluid.report.phone':'Tel.',
      'fluid.report.kind':'Informe',
      'fluid.report.kindValue':'Balance hídrico',
      'fluid.report.weight':'Peso',
      'fluid.report.modality':'Modalidad',
      'fluid.report.center':'Centro',
      'fluid.report.clinician':'Médico',
      ...
      'fluid.report.inflows':'INGRESOS - LÍQUIDOS POR BOCA',
      'fluid.report.outflows':'EGRESOS - ORINA',
      'fluid.report.time':'Hora',
      'fluid.report.type':'Tipo',
      'fluid.report.amount':'Cantidad',
      'fluid.report.note':'Observación',
      'fluid.report.noSideEntries':'Sin registros.',
      ...
      'fluid.report.footerLead':'Cada registro ayuda a ',
      'fluid.report.footerEnd':'cuidar un riñón.'
    },
    en:{
      ...
      'fluid.settings.eyebrow':'Optional module',
      'fluid.settings.title':'Fluid intake and urine tracking',
      'fluid.settings.subtitle':'Enable it only if you need to track the daily fluid balance.',
      'fluid.settings.enable':'Show fluid tracking',
      'fluid.settings.enableHelp':'Adds fluid intake, urine output and both balances to Home.',
      'fluid.settings.keepData':'If you disable it, existing records are preserved and will reappear when you enable it again.',
      ...
      'fluid.balance.completedOnly':'Dialysis data includes completed exchanges only.',
      ...
      'fluid.report.of':'of',
      'fluid.report.idHistory':'ID / MRN',
      'fluid.report.responsible':'Caregiver',
      'fluid.report.phone':'Phone',
      'fluid.report.kind':'Report',
      'fluid.report.kindValue':'Fluid balance',
      'fluid.report.weight':'Weight',
      'fluid.report.modality':'Modality',
      'fluid.report.center':'Center',
      'fluid.report.clinician':'Clinician',
      ...
      'fluid.report.inflows':'INFLOWS - ORAL FLUIDS',
      'fluid.report.outflows':'OUTFLOWS - URINE',
      'fluid.report.time':'Time',
      'fluid.report.type':'Type',
      'fluid.report.amount':'Amount',
      'fluid.report.note':'Note',
      'fluid.report.noSideEntries':'No records.',
      ...
      'fluid.report.footerLead':'Every record helps ',
      'fluid.report.footerEnd':'care for a kidney.'
    }
  };
  ...
  const EN={
    ...
    'Intercambios completados':'Completed exchanges','Registros de diálisis':'Dialysis records','Infundido manual':'Manual infused','Drenado manual':'Manual drained','Balance integrado':'Integrated balance','Volumen total infundido':'Total infused volume',
    ...
    'Resumen del período':'Period summary','Resumen integrado del período':'Integrated period summary','Balance neto por día':'Net balance by day','Sin datos para el período':'No data for the period',
    ...
    'Responsable:':'Caregiver:','Tel:':'Phone:','Diálisis Peritoneal Manual (CAPD)':'Manual Peritoneal Dialysis (CAPD)','Diálisis Peritoneal Automatizada (APD)':'Automated Peritoneal Dialysis (APD)','Mixta (Manual + APD)':'Mixed (Manual + APD)',
    'N°':'No.','Tipo / N°':'Type / No.','Fecha / hora':'Date / time','inicio':'start','infusión':'infusion','Volumen':'Volume','infundido':'infused',
